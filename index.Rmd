...
[https://MartinSchweinberger.github.io/SLAT7829](https://MartinSchweinberger.github.io/SLAT7829)

Lecture recordings and tutorial recordings are made available on Blackboard.

### Recommended Resources {-}

@schweinberger2022introta
...
3. R data visualization with RStudio and ggplot2: introduction  
...
content <- c(
  "Preface | Introduction to Text and Corpus Analysis",
  "Introduction to Text and Corpus Analysis",
  "Introduction to AntConc",
  "Using AntConc for Text and Corpus Analysis",
  "Getting started with R and RStudio",
  "String Processing in R and Rstudio",
  "Visualizing textual data",
  "Frequency lists and collocations",
  "Collocations and basic statz for text analysis",
  "Network Analysis",
  "Pos-tagging and parsing",
  "Sentiment Analysis",
  "Topic Models and round-up"
)
scriptchapter <- c(
  "Introduction to the course | Introduction to Text and Corpus Analysis",
  "Introduction to Text and Corpus Analysis",
  "Introduction to AntConc",
  "Using AntConc for Text and Corpus Analysis",
  "Getting started with R and RStudio",
